...
export default function ResultsCreate({ event, participants, houses }) {
    ...
    const handleParticipantChange = (participantId) => {
        ...
        setData(prevData => ({
            ...
            house_id: participant ? participant.house_id : '',
        }));
    };
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Catatan Masa / Catatan</label>
                                    <input type="text" value={data.time_record} onChange={(e) => setData('time_record', e.target.value)} className="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="12.34s" />
                                </div>
