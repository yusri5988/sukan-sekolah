...
export default function MeetsEdit({ meet }) {
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <div className="inline-flex items-center gap-2 mb-2">
                            ...
                            <span className="text-orange-600 text-xs font-black uppercase tracking-[0.3em]">Kemas Kini Kejohanan</span>
                        </div>
                        <h2 className="text-4xl lg:text-6xl font-black italic uppercase tracking-tighter text-slate-900 leading-[0.85]">
                            Edit <span className="text-orange-600">Kejohanan</span>
                        </h2>
                    </div>
                    <Link
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 font-bold italic">
                                    Kemas kini butiran kejohanan dan konfigurasi mata.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="Kejohanan Sukan Tahunan 2026"
                                        />
                                        {errors.name && (
